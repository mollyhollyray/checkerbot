...
│  🔹 /releases - Проверить обновления релизов
└───────────────────────────────
...
• Сообщение
• Ссылку`,
releases: `✨ *Команда /releases* ✨
━━━━━━━━━━━━━━━━━━
Показывает релизы репозитория

📌 *Формат:*
\`/releases owner/repo [limit]\`

📌 *Примеры:*
\`/releases facebook/react\`
\`/releases vuejs/core 5\`
...
📌 *Примеры:*
\`/logs\` - 20 последних строк
\`/logs 50\` - 50 последних строк
