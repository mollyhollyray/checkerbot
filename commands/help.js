...
📌 *Формат:*
\`/list\` - Первая страница
\`/list 2\` - Вторая страница
...
• 🔸 Активность
• 📊 Статистику по типам
• 👥 Группировку по владельцам
• 📄 Навигацию по страницам

📌 *Особенности:*
• Пагинация при большом количестве репозиториев
• Визуальное разделение типов отслеживания
• Быстрый доступ к командам для каждого репозитория`,
...
📌 *Отображает:*
• Количество репозиториев у каждого владельца
• Активные репозитории
• Даты добавления и проверки
...
untrackowner: `✨ *Команда /untrackowner* ✨
━━━━━━━━━━━━━━━━━━
Удаляет владельца из автоматического отслеживания

📌 *Формат:*
\`/untrackowner username\`

📌 *Пример:*
\`/untrackowner facebook\`

⚠️ *Удаляет все авто-добавленные репозитории*`,
