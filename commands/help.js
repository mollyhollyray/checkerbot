...
│  👁️ /prview - Детали PR
│  📦 /releases - Релизы
│  ✉️ /report - Автоматический вызов отчета
└───────────────────────────────
...
📖 <i>Пример:</i> <code>/help add</code>`,
  ...
  stats: `✨ <b>Команда /stats</b> ✨
━━━━━━━━━━━━━━━━━━
Показывает дашборд со статистикой отслеживания
...
• 📋 Список репозиториев - переход к /list
• 👥 Статистика владельцев - /ownerstats
• 🔄 Проверить сейчас - ручной запуск проверки
• 📈 Детальная статистика - расширенная аналитика
• 🔄 Обновить дашборд - актуальные данные

📌 <b>Метрики активности:</b>
• 🟢 Очень активные (≤7 дней)
• 🟡 Активные (≤30 дней) 
• 🟠 Умеренные (≤90 дней)
• 🔴 Спящие (>90 дней)

📌 <b>Метрики здоровья:</b>
• ✅ Здоровые - активные репозитории
• ⚠️ Требуют внимания - умеренная активность
• 🚨 Критические - неактивные или с ошибками
...
⚠️ <b>Только для администратора</b>`,
  ...
  analytics: `✨ <b>Команда /analytics</b> ✨
━━━━━━━━━━━━━━━━━━
Показывает расширенную аналитику и метрики

📌 <b>Что анализирует:</b>
• 📅 Временные метрики и возраст репозиториев
• 🕒 Распределение активности по часам
• 📊 Статистика коммитов по времени суток
• 🎯 Анализ паттернов активности
• 📈 Тренды и закономерности

📌 <b>Отличие от /stats:</b>
• /stats - общий дашборд с основными показателями
• /analytics - глубокая аналитика и временные метрики

📌 <b>Временные метрики:</b>
• Средний возраст репозиториев
• Самый старый репозиторий
• Распределение активности по UTC часам
• Паттерны коммитов в течение дня

📌 <b>Визуализация:</b>
• Графики активности в текстовом формате
• Статистика по часам с прогресс-барами
• Сравнительный анализ временных метрик

💡 <b>Для чего полезно:</b>
• Определение пиков активности
• Анализ рабочих паттернов команд
• Выявление трендов разработки
• Планирование времени проверок

🔍 <b>Глубокая аналитика для продвинутых метрик</b>
...
report: `✨ <b>Команда /report</b> ✨
━━━━━━━━━━━━━━━━━━
Генерирует отчеты с графиками и аналитикой

📌 <b>Формат:</b>
<code>/report [type]</code>

📌 <b>Типы отчетов:</b>
• <code>daily</code> - Ежедневный отчет (по умолчанию)
• <code>weekly</code> - Еженедельный отчет
• <code>test</code> - Тестовый график

📌 <b>Автоматические отчеты:</b>
• 📅 Ежедневные - 09:00 каждый день
• 📈 Еженедельные - 10:00 каждый понедельник

📌 <b>Что включает:</b>
• 📊 ASCII-графики активности
• 📈 Тренды и метрики
• 🏆 Рейтинги владельцев
...
🎨 <b>Визуализация:</b>
• Графики активности за 7/30 дней
...
module.exports = async (ctx) => {
  ...
  try {
    ...
    const buttons = [
      [
        { text: "🖥️ Дашборд", callback_data: "help_stats" },
        { text: "📈 Аналитика", callback_data: "help_analytics" },
        { text: "📋 Список", callback_data: "help_list" },
        { text: "🗒️ Отчеты", callback_data: "help_report" }
      ],
      [
      ...
      [
        ...
        { text: "🖇️ PR", callback_data: "help_pr" }
      ],
    ];
